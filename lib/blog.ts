...
export const BLOG_POSTS: BlogPost[] = [
...

  {
    ...
    content: [
      ...
      { type: 'p', text: 'The gorse is flowering in April — yellow across the dune ridges, which looks spectacular from an aesthetic point of view and is a complete nightmare from a golf ball perspective. If anything, gorse in April is denser and harder to escape than at other times of year. Play to avoid it, not through it.' },
