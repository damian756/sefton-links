...
export const BLOG_POSTS: BlogPost[] = [
...

  {
    ...
    content: [
      ...
      { type: 'p', text: 'Do not drive to the course. The official park and ride is the correct approach. Southport town centre shuttle buses run throughout championship days. If you are coming by train, Birkdale station is the nearest stop and it is an easy walk from there.' },
...

  {
    ...
    content: [
      ...
      { type: 'h2', text: 'Getting There' },
      { type: 'p', text: 'The Merseyrail Southport line runs direct from Liverpool Central to Birkdale station. From Birkdale station it is a short walk to the course entrance. This is the recommended approach for most visitors. Parking within walking distance of the course on competition days will not exist. Do not plan around it.' },
...

  {
    ...
    content: [
      ...
      { type: 'p', text: 'Hiring a car is the sensible option unless you are using the train. Hall Road station is close to West Lancs. Formby station is close to Formby Golf Club. Birkdale station is the right stop for the Birkdale corridor courses.' },
